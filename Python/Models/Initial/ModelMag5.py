...
cp_callback = callbacks.ModelCheckpoint(filepath=r'checkpoints\ModelMag5\ModelMag5-best.ckpt',
                                        save_weights_only=True, monitor='val_loss', mode='min',
                                        save_best_only=True, verbose=1, save_freq='epoch')

csv_logger = callbacks.CSVLogger(r'checkpoints\ModelMag5\ModelMag5-log.csv')
