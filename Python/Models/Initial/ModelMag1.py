...
cp_callback = callbacks.ModelCheckpoint(filepath=r'checkpoints\ModelMag1\ModelMag1-best.ckpt',
                                        save_weights_only=True, monitor='val_loss', mode='min',
                                        save_best_only=True, verbose=1, save_freq='epoch')

csv_logger = callbacks.CSVLogger(r'checkpoints\ModelMag1\ModelMag1-log.csv')
