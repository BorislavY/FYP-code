...
cp_callback = callbacks.ModelCheckpoint(filepath=r'checkpoints/ModelMag12/ModelMag12-best.ckpt',
                                        save_weights_only=True, monitor='val_loss', mode='min',
                                        save_best_only=True, verbose=1, save_freq='epoch')

csv_logger = callbacks.CSVLogger(r'checkpoints/ModelMag12/ModelMag12-log.csv')
