...
model = Sequential()
model.add(layers.Bidirectional(layers.LSTM(512, input_shape=(431, 1025), return_sequences=True, dropout=0.5),
                               merge_mode='sum'))
model.add(layers.Bidirectional(layers.LSTM(512, return_sequences=True, dropout=0.5), merge_mode='sum'))
